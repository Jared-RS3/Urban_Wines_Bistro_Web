        ...
        <div className="about-grid">
          ...
          <div className="about-text">
            ...
            <p className="reveal reveal-delay-2">
              Urban Wines brings together curated selections from Durbanville's finest vineyards, offering bold reds, crisp whites, and exclusive reserves for true wine lovers.
            </p>
