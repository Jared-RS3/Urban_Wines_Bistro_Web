...
/* ── Rich Instagram post data – Urban Wines Bistro ── */
const POSTS = [
  {
    id: 1,
  ...
  },
  {
    ...
    accent: '#C6A75E',
    caption: 'Friday evenings at Urban Wines. Candlelight, a glass of Shiraz, and nowhere else to be.',
    tag: '#UrbanVibes',
    likes: '1.5k',
    visual: 'candle',
  },
      ...
      <div className="lifestyle-hero">
        ...
        <div className="lifestyle-content">
          ...
          <p className="reveal reveal-delay-2" style={{ color: 'var(--text-muted)', maxWidth: 500, margin: '0 auto' }}>
            Wine, coffee, cocktails & curated small plates — Urban Wines Bistro is Durbanville's
