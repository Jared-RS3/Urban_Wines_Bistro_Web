    ...
    <footer className="footer">
      <div className="footer-grid">
        <div className="footer-brand">
          <h3 style={{ fontFamily: 'var(--font-serif)', color: 'var(--off-white)', margintop: 0 }}>Neighbourhood Wines</h3>
          <p style={{ marginTop: 0 }}>
      ...
      <div className="footer-bottom">
        <span>© {year} Neighbourhood Wines, Durbanville. All rights reserved.</span>
        <span>
